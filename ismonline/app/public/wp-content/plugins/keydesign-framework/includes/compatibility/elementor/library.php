 ...
 * @since 1.0.0
 */
class KeyDesign_Source extends Source_Base {

	const API_TEMPLATES_URL = 'https://library.keydesign.xyz/wp-json/kd/v1/templates';

	private static $api_get_template_content_url = 'https://library.keydesign.xyz/wp-json/kd/v1/templates/%d/content';
